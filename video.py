...
"""
!!!!!!!!!!!!!!!!!!!!
Only difference with the realtime feed from camera is
that this works on a pre-recorded video
(path supplied in line 17, everything else
is same)
!!!!!!!!!!!!!!!!!!!!
"""
import cv2
...
camera_stream = cv2.VideoCapture('images/misha.mp4')
